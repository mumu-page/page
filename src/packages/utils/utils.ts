...
export function isSelct(componentKey: string) {
    return ['Select', 'Cascader', 'TimePicker', 'TimePicker.RangePicker', 'DatePicker', 'DatePicker.RangePicker'].includes(componentKey)
}

export function hasNotPlaceholder(componentKey: string) {
    return ['Radio', 'Checkbox', 'Switch', 'Slider', 'Rate', 'Upload', 'Row', 'Button'].includes(componentKey)
}
