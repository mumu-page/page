...
import { PlayCircleOutlined, EyeOutlined, VerticalAlignBottomOutlined, CopyOutlined, DeleteOutlined, LayoutTwoTone, ExclamationCircleOutlined } from "@ant-design/icons";
import { Context } from '../stores/context';
import { SET_COMPONENT_LIST, SET_FLAG, SET_SHOW_NOT_FOUNT } from '../stores/action-type';
  ...
  return (
    <>
      ...
      <div className='actions'>
        ...
        <Button icon={<DeleteOutlined />} type="link" danger size='large' onClick={clean}>清空</Button>
      </div>
    </>
  );
}
