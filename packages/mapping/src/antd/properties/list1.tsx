...
import { FORM_POOLS, FORM_PROPERTIES_OPTIONS } from '../../constants'
...
export default memo(function () {
    ...
    return (
      ...
      >
        <Select>
          {FORM_POOLS.map((item) => {
            return (
              <OptGroup label={item.label} key={shortid()}>
  ...
  return (
    ...
    >
      <Collapse defaultActiveKey={['设置列表每项元素']}>
        <Collapse.Panel header="设置列表每项元素" key="设置列表每项元素">
